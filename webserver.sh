...
sed -i "s|^<title>Welcome to nginx\!</title>|<title>Nginx-Azure</title>|" /var/www/html/index.nginx-debian.html
sed -i "s|^<h1>Welcome to nginx\!</h1>|<h1>Welcome to nginx in Azure\!</h1>|" /var/www/html/index.nginx-debian.html
